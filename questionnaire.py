...
# 创建CSV文件并获取写入对象
csv_file = open('qnr.csv', 'w', newline='', encoding='utf-8')
...
headers = ['Pillar Name', 'Question Title', 'Choice Title', 'Question ID', 'Choice ID', 'TA_checked', 'resource_comments']
...
for pillar in data['pillars']:
    ...
    for question in pillar['questions']:
        ...
        for choice in question['choices']:
            ...
            ta_checked = "Yes" if "Trusted Advisor Checks" in helpful_resource_str else "No"
            ...
            row = [pillar_name, question_title, choice_title, question_id, choice_id, ta_checked, resource_comments]
